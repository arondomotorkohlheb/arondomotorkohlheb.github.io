...
file_path = r'local_0_greedy.npy'
...
t = np.linspace(0, 200, data.shape[0])
...
line_mean, = axs[2].plot(t, P_gen_avg, linewidth=3, color=color_11th, label=r'$P_{\Sigma}/N$')

axs[2].set_ylabel(r'$P$ [W]')
axs[2].set_title(r'$P_{1:N}$, $P_{\Sigma}/N$')
axs[2].set_xlabel(r'Time [s]')
axs[2].grid(True)
axs[2].legend(loc='center left', bbox_to_anchor=(-0.4, 2.33), fontsize=11, ncol=1)
